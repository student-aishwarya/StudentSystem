...
<div class="max-w-xl mx-auto bg-white shadow-md rounded-lg p-6">
    ...
    <form action="{{ url('notes') }}" method="POST" class="space-y-5">
        @csrf
        ...
        <!-- Description Field -->
        <div>
            <label for="description" class="block text-sm font-medium text-gray-700 mb-1">Take a note...</label>
            <textarea name="description" id="description" rows="4" required
                      class="w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-2 focus:ring-yellow-400 focus:outline-none"></textarea>
        </div>
        ...
        <div>
         ...
         <div>
            <label for="name" class="block text-sm font-medium text-gray-700 mb-1">basant</label>
